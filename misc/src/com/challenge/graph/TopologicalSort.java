...
public class TopologicalSort<T> {
    ...
    public Deque<Vertex<T>> topoplogicalSort(Graph<T> graph) {
        ...
        for (Vertex<T> vertex : graph.getAllVertex()) {
            ...
            topoSortUtil(vertex, stack, visited);
        }
        return stack;
    }

    private void topoSortUtil(Vertex<T> vertex, Deque<Vertex<T>> stack,
        ...
        for (Vertex<T> childVertex : vertex.getAdjacentVertexes()) {
            ...
            topoSortUtil(childVertex, stack, visited);
        }
    ...
    public static void main(String args[]) {
        ...
        Deque<Vertex<Integer>> result = sort.topoplogicalSort(graph);
